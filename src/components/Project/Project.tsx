...
export const Project: FC<Props> = ({ projectData }) => {
  return (
    <li className="p-4  drop-shadow-lg rounded-lg hover:bg-blue cursor-pointer ease-in-out duration-300">
      <a href={projectData.link} target="_blank" className="flex space-x-5">
        ...
        <div className="flex flex-col space-2">
          <h3 className="font-medium text-primary text-xl">{projectData.title}</h3>
          <p className="text-sm text-brown font-medium">{projectData.description}</p>
